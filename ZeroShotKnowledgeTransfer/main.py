...
if __name__ == "__main__":
    ...
    parser.add_argument('--teacher_architecture', type=str, default='WRN-40-1')
    ...
    parser.add_argument('--save_final_model', type=str2bool, default=1)
